function Slider() {
    this.imagesUrls = [],
        this.showPrevBtn = null; // document.querySelector(".showPrev"),
    this.showNextBtn = null; //document.querySelector(".showNext"),
    this.sliderImage = null; //document.querySelector(".sliderImage"),
    this.currentImage = 0;
    this.start = function (elId) {
            const that = this;
        let elSelector = "#" + elId;
        let el = document.querySelector(elSelector);
        this.showPrevBtn = el.querySelector(".showPrev");
    ...
    this.onShowPrevClick = function (event) {
        this.currentImage--
        this.sliderImage.src = this.imagesUrls[this.currentImage];
    ...
    this.onNextPrevClick = function (event) {
        this.currentImage++;
        this.sliderImage.src = this.imagesUrls[this.currentImage];
